 ...
 */
public class AnySuffixTree {

    private class SuffixNode {
        private StringBuilder sb;

        private List<SuffixNode> children = new LinkedList<SuffixNode>();
        private Map<Character, SuffixNode> pairs = new HashMap<Character, SuffixNode>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        AnySuffixTree stree = new AnySuffixTree();
        stree.buildSuffixTree(text);
        stree.printTree();

        System.out.println("****************************");
        text = "mississippi^";
        stree = new AnySuffixTree();
        stree.buildSuffixTree(text);
        stree.printTree();
